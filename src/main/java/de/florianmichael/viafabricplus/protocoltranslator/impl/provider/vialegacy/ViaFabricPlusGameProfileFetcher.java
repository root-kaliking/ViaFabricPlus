...
import net.raphimc.vialegacy.protocols.release.protocol1_7_6_10to1_8.model.GameProfile;
import net.raphimc.vialegacy.protocols.release.protocol1_7_6_10to1_8.provider.GameProfileFetcher;
